(function () {
  ...
  function getNavMarkup(page, withProgress) {
    ...
    return '' +
      ...
      '</div>' +
      (withProgress
        ? '<div class="nav__progress" aria-hidden="true"><div class="nav__progress-track"><div class="nav__progress-fill" id="scroll-fill"></div></div><span class="nav__progress-label" id="scroll-label">0%</span></div>'
        : '') +
