(function () {
  ...
  function getNavMarkup(page, withProgress) {
    ...
    return '' +
      ...
      '</div>' +
      (withProgress
        ? '<div class="nav__center"><div class="nav__progress" aria-hidden="true"><div class="nav__progress-track"><div class="nav__progress-fill" id="scroll-fill"></div></div><span class="nav__progress-label" id="scroll-label">0%</span></div><span class="nav__section-indicator" id="scroll-section" aria-hidden="true"><span class="nav__progress-dot" aria-hidden="true"></span><span class="nav__progress-section-label">Hero</span></span></div>'
        : '') +
